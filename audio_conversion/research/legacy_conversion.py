################################################################################
# Filename: legacy_conversion.py
# Purpose:  Perform audio processing and conversion tasks to MIDI.
# Author:   Livia Chandra, Roshni Venkat, & Darren Seubert
#
# Description:
# This is the legacy version of conversion.py which was used in the initial
# implementation of the audio to MIDI conversion feature. It has been replaced
# in favor of conversion.py in this version of MelodyMapper.
#
